...
conway.wad: conway_nomapinfo.wad mapinfo.txt umapinfo.txt mancubus.bex conway.txt
	python3 add_lumps.py -i conway_nomapinfo.wad -o $@ -z mapinfo.txt -u umapinfo.txt -d mancubus.bex -w conway.txt
